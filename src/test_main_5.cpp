...
// *******************************************************************************************************************************************************************
	...
	//构建算法
	WOA_Algorithm woa(calc_fitness_woa, para_low_bound, para_up_bound, dimension, student_whale_count);
...
//***************************************************************************************************************************************************
		...
		cout << "best fitness found is: " << "  " << woa_tlbo_fitness[student_whale_count - 1] << endl;
		for (int j = 0; j < dimension; j++){
